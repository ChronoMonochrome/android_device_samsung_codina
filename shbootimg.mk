...
RECOVERY_RAMDISK := $(LOCAL_PATH)/prebuilt/ramdisk-recovery.cpio
BOOT_RAMDISK := $(LOCAL_PATH)/prebuilt/ramdisk.cpio

TARGET_KERNEL_BINARIES: $(KERNEL_OUT) $(KERNEL_CONFIG) $(KERNEL_HEADERS_INSTALL) $(RECOVERY_RAMDISK) $(BOOT_RAMDISK)
